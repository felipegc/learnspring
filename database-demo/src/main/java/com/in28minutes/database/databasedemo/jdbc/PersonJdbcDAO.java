...
// using a custom mapper
    ...
    public List<Person> findByNameContent(String nameContent) {
        return jdbcTemplate.query("select * from person where name like ?",
                new String[]{"%"+nameContent+"%"},
                new BeanPropertyRowMapper<Person>(Person.class));
    }
    ...
    public int deleteByNameContent(String nameContent) {
        return jdbcTemplate.update("delete from person where name like ?",
                new String[]{"%"+nameContent+"%"});
    }
